      ...
      <div className="terms-container">
        ...
        <div className="terms-hero">
          ...
          <p className="terms-subtitle">
            ...
            เพื่อให้เข้าใจตรงกัน ทำงานราบรื่น และได้ระบบที่มีคุณภาพตรงใจที่สุดครับ
          </p>
        </div>
              ...
              <div className="terms-cards-grid">
                ...
                <div className="terms-card">
                  ...
                  <p className="terms-card-text">
                    ...
                    <br />
                    หากมีงบประมาณจำกัด สามารถแจ้งงบประมาณที่มีก่อนได้เสมอ ทางเรายินดีช่วยวิเคราะห์และปรับลดทอนฟีเจอร์ที่ไม่จำเป็น เพื่อให้ได้ระบบที่คุ้มค่าและตอบโจทย์ธุรกิจของท่านมากที่สุด ปรึกษาฟรีไม่มีข้อผูกมัดครับ
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="terms-section" id="section-faq">
              ...
              <div className="terms-cards-grid">
                <div className="terms-card">
                  ...
                  <p className="terms-card-text">
                    <strong>ได้แน่นอน 100% ครับ!</strong> เราออกแบบระบบให้ใช้งานง่าย พร้อมส่งมอบคู่มือภาษาไทยแนะนำการเปิด-ปิด หรือหากต้องการ เราสามารถพัฒนาหน้าจัดการหลังบ้าน (Admin Dashboard) ให้ลูกค้าคลิกแก้ไขข้อความ รูปภาพ หรือข้อมูลได้เองโดยไม่ต้องแตะโค้ดเลยครับ
                  </p>
                </div>
                ...
                <div className="terms-card">
                  ...
                  <p className="terms-card-text">
                    <strong>เรทราคาขึ้นอยู่กับแต่ละงานครับ</strong> ทั้งความซับซ้อนของตรรกะระบบ ปริมาณหน้า ดีไซน์ และการเชื่อมต่อภายนอก (เช่น ระบบตรวจสลิป, ฐานข้อมูล, API) งานที่เรียบง่ายจะมีค่าบริการเริ่มต้นเพียงหลักร้อย ในขณะที่งานระบบขนาดใหญ่จะคำนวณตามเวลาและทรัพยากรที่ใช้พัฒนาจริงครับ
                  </p>
                </div>
                ...
                <div className="terms-card">
                  ...
                  <p className="terms-card-text">
                    <strong>ไม่มีค่าใช้จ่ายแอบแฝงครับ!</strong> ค่าจ้างพัฒนาเป็นแบบจ่ายครั้งเดียวจบ ส่วนค่าบริการภายนอก เช่น ค่าโดเมน หรือค่าเช่า Cloud VPS ลูกค้าจะชำระตรงกับผู้ให้บริการตามจริงตามการใช้งาน (หรือหากเป็นเว็บ Landing Page สามารถใช้คลาวด์ฟรีได้โดยไม่มีค่าใช้จ่ายรายเดือนเลยครับ)
                  </p>
                </div>
                ...
                <div className="terms-card">
                  ...
                  <p className="terms-card-text">
                    <strong>สามารถติดต่อมาขอเพิ่มฟังก์ชันได้ตลอดเวลาครับ</strong> โค้ดถูกเขียนแบบแยกโมดูล (Clean & Modular Architecture) ทำให้การต่อเติมฟังก์ชันใหม่ทำได้สะดวกรวดเร็ว โดยจะคิดค่าบริการเฉพาะส่วนที่พัฒนาเพิ่มตามความยากง่าย เป็นกันเองแน่นอนครับ
                  </p>
                </div>
                ...
                <div className="terms-card">
                  ...
                  <p className="terms-card-text">
                    <strong>รับครับ!</strong> ลูกค้าสามารถส่งโค้ดเดิมหรือรายละเอียดระบบที่มีอยู่มาให้เราประเมินโครงสร้างก่อนได้ฟรี เราจะช่วยวิเคราะห์ความเป็นไปได้ แนวทางแก้ไข และประเมินราคาให้พิจารณาก่อนเริ่มงานครับ
                  </p>
                </div>
                ...
                <div className="terms-card">
                  ...
                  <p className="terms-card-text">
                    <strong>ทุกโปรเจกต์มีประกันตรวจแก้บั๊กฟรี 30 วันเต็มครับ</strong> หากเกิดปัญหาจากโค้ดเดิม ทางเราแก้ไขให้ฟรีทันที และสำหรับการรันบอทเรามีการตั้งค่า Process Manager (เช่น PM2 หรือ Docker) ให้รีสตาร์ตตัวเองอัตโนมัติหากระบบขัดข้อง ทำให้ระบบเปิดทำงานได้ต่อเนื่อง 24/7 ครับ
                  </p>
                </div>
                ...
                <div className="terms-card">
                  ...
                  <p className="terms-card-text">
                    <strong>รองรับครบวงจรครับ!</strong> สามารถเชื่อมต่อทั้งระบบตรวจสลิปธนาคารแบบเรียลไทม์ (Slip Verification API), ระบบแจ้งเตือนเงินเข้าผ่าน Discord Webhook / LINE Notify, หรือระบบเกตเวย์ชำระเงินชั้นนำ เช่น PromptPay QR Code, Stripe หรือ Omise
                  </p>
                </div>
                ...
                <div className="terms-card">
                  ...
                  <p className="terms-card-text">
                    <strong>แบ่งชำระเป็น 2 งวดครับ</strong> งวดที่ 1 มัดจำ 50% ก่อนเริ่มงานเพื่อล็อกคิว และงวดที่ 2 อีก 50% เมื่องานเสร็จสิ้นและให้ลูกค้าทดสอบตรวจรับงานเรียบร้อย ก่อนส่งมอบซอร์สโค้ดและติดตั้งบนระบบจริง (กรณีงานขนาดเล็กยอดไม่เกิน 500 บาท ชำระเต็มจำนวนก่อนเริ่มงานครับ)
                  </p>
                </div>
              </div>
            </section>
        ...
        <div className="terms-contact-card">
          <div className="terms-contact-card-body">
            ...
            <p className="terms-contact-card-desc">
              หากมีข้อสงสัยเกี่ยวกับขอบเขตงานหรือต้องการปรึกษาเรทราคา ทักมาพูดคุยก่อนได้ตลอดครับ เป็นกันเองและยินดีแนะนำโซลูชันที่คุ้มค่าที่สุดให้ครับ
            </p>
