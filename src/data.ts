...
export const servicesData: ServiceItem[] = [
  {
    title: 'รับเขียนโค้ด & พัฒนาระบบครบวงจร',
    desc: 'รับพัฒนาซอฟต์แวร์ครอบคลุมทั้ง Frontend, Backend สถาปัตยกรรมระบบความปลอดภัยสูง (Security & Hardening) ตลอดจนระบบงานสำคัญและฐานข้อมูลขนาดใหญ่ ดูแลครบตั้งแต่การออกแบบ สถาปัตยกรรม จนถึงติดตั้งบนคลาวด์',
    priceTiers: [
      { note: 'ระบบทั่วไป / โมดูลย่อย', price: '2,000 บาท' },
      { note: 'ระบบขนาดใหญ่ & โครงสร้างซับซ้อน', price: '15,000 บาท' }
    ],
    showHands: true
  },
  {
